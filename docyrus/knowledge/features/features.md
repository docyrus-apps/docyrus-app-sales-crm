...
- The dialog keeps orchestration/state in `lead-convert-dialog.tsx` while presentational sections are split into focused components: `lead-convert-mode-selector.tsx`, `lead-convert-progress.tsx`, `lead-convert-precheck-tooltip.tsx`, `lead-convert-reuse-banner.tsx`, and `lead-convert-change-confirm-dialog.tsx`.
