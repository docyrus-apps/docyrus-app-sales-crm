...
<AutoTypeTable path="./types/docs/scroll-spy.ts" name="ScrollSpyProps" />
...
<AutoTypeTable path="./types/docs/scroll-spy.ts" name="ScrollSpyNavProps" />
...
<AutoTypeTable path="./types/docs/scroll-spy.ts" name="ScrollSpyLinkProps" />
...
<AutoTypeTable path="./types/docs/scroll-spy.ts" name="ScrollSpySectionProps" />
...
<KeyboardShortcutsTable
  data={[
    ...
    },
    {
      keys: ['Enter'],
      description:
        'Activate the focused navigation item and scroll to the associated section.',
    },
    {
      keys: ['Space'],
      description:
