...
<KeyboardShortcutsTable
  data={[
    ...
    },
    {
      keys: ['Shift + Tab'],
      description:
        'Moves focus away from the slider to the previous focusable element.',
    },
    {
      keys: ['ArrowLeft', 'ArrowUp'],
      description:
        'Moves the slider position left (or up in vertical mode) by the step amount.',
    },
    {
      keys: ['ArrowRight', 'ArrowDown'],
      description:
        'Moves the slider position right (or down in vertical mode) by the step amount.',
    },
    {
      keys: ['PageUp'],
      description:
        'Moves the slider position left (or up in vertical mode) by ten steps.',
    },
    {
      keys: ['PageDown'],
      description:
        'Moves the slider position right (or down in vertical mode) by ten steps.',
    },
    {
...
<CompareSlider orientation="vertical" className="h-[600px]">
  <CompareSliderBefore>{/* Top content */}</CompareSliderBefore>
  <CompareSliderAfter>{/* Bottom content */}</CompareSliderAfter>
  <CompareSliderHandle />
</CompareSlider>
```
