...
preview: true
links:
  api: /docs/components/color-swatch#api-reference
---

<ComponentTabs name="color-swatch-demo" />
...
```package-install
pnpm dlx shadcn@latest add @diceui/color-swatch
...
<DataAttributesTable
  data={[
    ...
    {
      title: '[data-slot]',
      value: "Always set to 'color-swatch' for identification.",
    },
  ]}
/>
