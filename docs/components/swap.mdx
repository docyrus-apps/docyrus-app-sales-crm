...
<AutoTypeTable path="./types/docs/swap.ts" name="SwapProps" />
...
<AutoTypeTable path="./types/docs/swap.ts" name="SwapOnProps" />
...
<AutoTypeTable path="./types/docs/swap.ts" name="SwapOffProps" />
