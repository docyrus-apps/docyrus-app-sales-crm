...
<AutoTypeTable path="./types/docs/rating.ts" name="RatingProps" />
...
<AutoTypeTable path="./types/docs/rating.ts" name="RatingItemProps" />
...
<KeyboardShortcutsTable
  data={[
    ...
    },
    {
      keys: ['Enter', 'Space'],
      description:
        "Activate the focused rating item (when activationMode is 'manual').",
    },
    {
      keys: ['Escape'],
