...
<ComponentTabs
  name="editable-demo"
  className="items-start justify-start [&>div]:pt-20"
/>
...
<AutoTypeTable path="./types/docs/editable.ts" name="EditableProps" />

### EditableLabel

The label component for the editable field.

<AutoTypeTable path="./types/docs/editable.ts" name="EditableLabelProps" />
...
<AutoTypeTable path="./types/docs/editable.ts" name="EditableAreaProps" />
...
<AutoTypeTable path="./types/docs/editable.ts" name="EditablePreviewProps" />
...
<AutoTypeTable path="./types/docs/editable.ts" name="EditableInputProps" />

### EditableTrigger

Button to trigger edit mode.

<AutoTypeTable path="./types/docs/editable.ts" name="EditableTriggerProps" />
...
<AutoTypeTable path="./types/docs/editable.ts" name="EditableToolbarProps" />

### EditableSubmit

Button to submit changes.

<AutoTypeTable path="./types/docs/editable.ts" name="EditableSubmitProps" />

### EditableCancel

Button to cancel changes.

<AutoTypeTable path="./types/docs/editable.ts" name="EditableCancelProps" />
