...
<AutoTypeTable path="./types/docs/phone-input.ts" name="PhoneInputProps" />
...
<AutoTypeTable path="./types/docs/phone-input.ts" name="PhoneInputFieldProps" />
...
<KeyboardShortcutsTable
  data={[
    ...
    },
    {
      keys: ['Space', 'Enter'],
      description:
        'Opens the country dropdown when focused on the country select button.',
    },
    {
      keys: ['Escape'],
    ...
    },
    {
      ...
      description: 'Navigate through country items when the dropdown is open.',
    },
    {
      keys: ['Home', 'End'],
      description: 'Jump to first or last country in the list.',
    },
    {
      keys: ['Type to search'],
      description:
