...
<SpeedDial className="fixed right-4 bottom-4">
  ...
  <SpeedDialContent>{/* actions */}</SpeedDialContent>
</SpeedDial>
```

<Callout type="warn">
  **Important:** Apply `fixed` positioning to the `SpeedDial` root, not the
  `SpeedDialTrigger`. This ensures the content stays aligned with the trigger.
</Callout>
...
<AutoTypeTable path="./types/docs/speed-dial.ts" name="SpeedDialProps" />
...
<AutoTypeTable path="./types/docs/speed-dial.ts" name="SpeedDialTriggerProps" />
...
<AutoTypeTable path="./types/docs/speed-dial.ts" name="SpeedDialContentProps" />
...
<AutoTypeTable path="./types/docs/speed-dial.ts" name="SpeedDialItemProps" />
  ...
  data={[
    {
      ...
      description:
        'Duration of the animation for item appearance. Defaults to 200ms.',
    },
    {
...
<AutoTypeTable path="./types/docs/speed-dial.ts" name="SpeedDialActionProps" />

### SpeedDialLabel

A text label that describes the associated action.

<AutoTypeTable path="./types/docs/speed-dial.ts" name="SpeedDialLabelProps" />
  ...
  data={[
    {
      keys: ['Enter', 'Space'],
      description:
        'When focus is on the trigger, toggles the speed dial open/closed.',
    },
    {
      keys: ['Escape'],
    ...
    },
    {
      keys: ['Tab'],
      description:
        'Moves focus between actions. Closes the speed dial when focus moves out.',
    },
    {
      keys: ['Shift + Tab'],
      description:
        'Moves focus to the previous action. Closes the speed dial when focus moves out.',
    },
  ]}
/>
