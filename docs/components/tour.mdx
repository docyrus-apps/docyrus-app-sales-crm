...
<AutoTypeTable path="./types/docs/tour.ts" name="TourProps" />

### TourSpotlight

The spotlight backdrop that dims the page and highlights the target element with a cutout effect.

<AutoTypeTable path="./types/docs/tour.ts" name="TourSpotlightProps" />
...
<AutoTypeTable path="./types/docs/tour.ts" name="TourSpotlightRingProps" />
...
<AutoTypeTable path="./types/docs/tour.ts" name="TourStepProps" />
...
<AutoTypeTable path="./types/docs/tour.ts" name="TourCloseProps" />

### TourHeader

Container for the tour step's title and description.

<AutoTypeTable path="./types/docs/tour.ts" name="TourHeaderProps" />

### TourTitle

The title of the current tour step.

<AutoTypeTable path="./types/docs/tour.ts" name="TourTitleProps" />

### TourDescription

The description text for the current tour step.

<AutoTypeTable path="./types/docs/tour.ts" name="TourDescriptionProps" />

### TourFooter

Container for tour navigation controls and step counter.

<AutoTypeTable path="./types/docs/tour.ts" name="TourFooterProps" />

### TourStepCounter

Displays the current step number and total steps.

<AutoTypeTable path="./types/docs/tour.ts" name="TourStepCounterProps" />

### TourPrev

Button to navigate to the previous step.

<AutoTypeTable path="./types/docs/tour.ts" name="TourPrevProps" />

### TourNext

Button to navigate to the next step or complete the tour.

<AutoTypeTable path="./types/docs/tour.ts" name="TourNextProps" />

### TourSkip

Button to skip the entire tour.

<AutoTypeTable path="./types/docs/tour.ts" name="TourSkipProps" />

### TourArrow

An optional arrow element that points to the target element.

<AutoTypeTable path="./types/docs/tour.ts" name="TourArrowProps" />
  ...
  data={[
    {
      keys: ['Escape'],
      description:
        'Triggers the onEscapeKeyDown callback. Default behavior closes the tour unless prevented.',
    },
    {
      keys: ['Tab'],
      description:
        'Moves focus to the next focusable element within the tour content.',
    },
    {
      keys: ['Shift', 'Tab'],
      description:
        'Moves focus to the previous focusable element within the tour content.',
    },
    {
      keys: ['Enter', 'Space'],
      description:
        'Activates the focused button (next, previous, skip, or close).',
    },
  ]}
/>
