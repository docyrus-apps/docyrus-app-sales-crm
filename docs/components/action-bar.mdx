...
<AutoTypeTable path="./types/docs/action-bar.ts" name="ActionBarProps" />
...
<AutoTypeTable path="./types/docs/action-bar.ts" name="ActionBarGroupProps" />
...
<AutoTypeTable path="./types/docs/action-bar.ts" name="ActionBarItemProps" />
...
<AutoTypeTable path="./types/docs/action-bar.ts" name="ActionBarCloseProps" />
  ...
  data={[
    {
      keys: ['Tab'],
      description:
        'Moves focus to the next focusable element (Action Group or Close button).',
    },
    {
      keys: ['Shift', 'Tab'],
    ...
    },
    {
      keys: ['ArrowLeft'],
      description:
        'Moves focus to the previous item in the group (horizontal orientation).',
    },
    {
      keys: ['ArrowUp'],
      description:
        'Moves focus to the previous item in the group (vertical orientation).',
    },
    {
      keys: ['ArrowRight'],
      description:
        'Moves focus to the next item in the group (horizontal orientation).',
    },
    {
      keys: ['ArrowDown'],
      description:
        'Moves focus to the next item in the group (vertical orientation).',
    },
    {
      keys: ['Home'],
