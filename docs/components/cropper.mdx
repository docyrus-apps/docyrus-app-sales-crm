---
title: Cropper
description: A powerful image and video cropper with zoom, rotation, and customizable crop areas.
preview: true
links:
  api: /docs/components/cropper#api-reference
---

<ComponentTabs name="cropper-demo" />
...
```package-install
pnpm dlx shadcn@latest add @diceui/cropper
...
<ComponentTabs name="cropper-controlled-demo" />

### With File Upload

A cropper integrated with the [FileUpload](https://diceui.com/docs/components/file-upload) component for uploading and cropping images.

<ComponentTabs name="cropper-file-upload-demo" />

### Different Shapes

A cropper with different shapes and configuration options.

<ComponentTabs name="cropper-shapes-demo" />

### Video Cropping

A cropper that works with video content.

<ComponentTabs name="cropper-video-demo" />
...
<AutoTypeTable path="./types/docs/cropper.ts" name="CropperProps" />

### CropperImage

The image element to be cropped.

<AutoTypeTable path="./types/docs/cropper.ts" name="CropperImageProps" />

### CropperVideo

The video element to be cropped.

<AutoTypeTable path="./types/docs/cropper.ts" name="CropperVideoProps" />

### CropperArea

The crop area overlay that shows the selected region.

<AutoTypeTable path="./types/docs/cropper.ts" name="CropperAreaProps" />
...
<KeyboardShortcutsTable
  data={[
    {
      keys: ['Tab'],
      description: 'Moves focus to the cropper content.',
    },
    {
      keys: ['ArrowUp'],
      description: 'Moves the crop area up by the keyboard step amount.',
    },
    {
      keys: ['ArrowDown'],
      description: 'Moves the crop area down by the keyboard step amount.',
    },
    {
      keys: ['ArrowLeft'],
      description: 'Moves the crop area left by the keyboard step amount.',
    },
    {
      keys: ['ArrowRight'],
      description: 'Moves the crop area right by the keyboard step amount.',
    },
    {
      keys: ['Shift + Arrow Keys'],
      description:
        'Moves the crop area with finer precision (20% of keyboard step).',
    },
  ]}
/>
