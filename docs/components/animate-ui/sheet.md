...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/radix/sheet#sheet" text="Animate UI API Reference - Sheet Primitive" />
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/radix/sheet#sheettrigger" text="Animate UI API Reference - SheetTrigger Primitive" />
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/radix/sheet#sheetcontent" text="Animate UI API Reference - SheetContent Primitive" />
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/radix/sheet#sheetclose" text="Animate UI API Reference - SheetClose Primitive" />
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/radix/sheet#sheettitle" text="Animate UI API Reference - SheetTitle Primitive" />
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/radix/sheet#sheetdescription" text="Animate UI API Reference - SheetDescription Primitive" />
