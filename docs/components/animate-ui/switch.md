...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/radix/switch#switch" text="Animate UI API Reference - Switch Primitive" />

  <ExternalLink href="https://www.radix-ui.com/primitives/docs/components/switch#root" text="Radix UI API Reference - Switch.Root" />
</div>
