...
URL: /docs/components/animate/avatar-group
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/animate/avatar-group#avatargroup" text="Animate UI API Reference - AvatarGroup Primitive" />
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/animate/avatar-group#avatargrouptooltip" text="Animate UI API Reference - AvatarGroupTooltip Primitive" />
