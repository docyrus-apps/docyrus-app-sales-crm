...
preview: true
links:
  api: /docs/components/status#api-reference
---
...
```package-install
pnpm dlx shadcn@latest add @diceui/status
```
...
<AutoTypeTable path="./types/docs/status.ts" name="StatusProps" />
...
<AutoTypeTable path="./types/docs/status.ts" name="StatusIndicatorProps" />

### StatusLabel

The text label for the status.

<AutoTypeTable path="./types/docs/status.ts" name="StatusLabelProps" />
