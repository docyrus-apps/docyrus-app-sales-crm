---
title: Data Grid
description: A high-performance editable data grid component with virtualization, keyboard navigation, and comprehensive cell editing capabilities.
preview: true
links:
...
const onFilesDelete = React.useCallback(
...
<AutoTypeTable
  path="./types/docs/data-grid.ts"
  name="UseDataGridUndoRedoReturn"
/>
...
<AutoTypeTable
  path="./types/docs/data-grid.ts"
  name="GetDataGridSelectColumnProps"
/>
...
<AutoTypeTable
  path="./types/docs/data-grid.ts"
  name="DataGridSkeletonToolbarProps"
/>
...
<AutoTypeTable
  path="./types/docs/data-grid.ts"
  name="DataGridSkeletonGridProps"
/>
