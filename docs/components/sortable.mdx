...
links:
  ...
  api: /docs/components/sortable#api-reference
---
...
<AutoTypeTable path="./types/docs/sortable.ts" name="SortableProps" />

### SortableContent

Container for sortable items. Multiple `SortableContent` components can be used within a `Sortable` component.

<AutoTypeTable path="./types/docs/sortable.ts" name="SortableContentProps" />

### SortableItem

Individual sortable item component.

<AutoTypeTable path="./types/docs/sortable.ts" name="SortableItemProps" />
...
<AutoTypeTable path="./types/docs/sortable.ts" name="SortableItemHandleProps" />
...
<AutoTypeTable path="./types/docs/sortable.ts" name="SortableOverlayProps" />
  ...
  data={[
    {
      keys: ['Enter', 'Space'],
      description:
        'Picks up the sortable item for reordering when released, and drops the item in its new position when pressed again.',
    },
    {
      keys: ['ArrowUp'],
    ...
    },
    {
      keys: ['Esc'],
      description:
        'Cancels the sort operation and returns the item to its original position.',
    },
  ]}
/>
