...
preview: true
links:
  api: /docs/components/gauge#api-reference
---
...
<AutoTypeTable path="./types/docs/gauge.ts" name="GaugeProps" />
...
<DataAttributesTable
  data={[
    ...
    },
    {
      ...
      value:
        'The normalized gauge value as a decimal between 0 and 1 (only present when not indeterminate).',
    },
  ]}
/>
...
<AutoTypeTable path="./types/docs/gauge.ts" name="GaugeIndicatorProps" />
...
<AutoTypeTable path="./types/docs/gauge.ts" name="GaugeTrackProps" />
...
<AutoTypeTable path="./types/docs/gauge.ts" name="GaugeRangeProps" />
...
<AutoTypeTable path="./types/docs/gauge.ts" name="GaugeValueTextProps" />
...
<AutoTypeTable path="./types/docs/gauge.ts" name="GaugeLabelProps" />
