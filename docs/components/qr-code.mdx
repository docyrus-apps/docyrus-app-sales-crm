...
```package-install
pnpm dlx shadcn@latest add @diceui/qr-code
```
...
<AutoTypeTable path="./types/docs/qr-code.ts" name="QRCodeProps" />
  ...
  data={[
    {
      title: '--qr-code-size',
      description:
        'The size of the QR code in pixels. Used to constrain child elements to the QR code dimensions.',
...
<AutoTypeTable path="./types/docs/qr-code.ts" name="QRCodeImageProps" />

### Canvas

Renders the QR code using HTML5 Canvas.

<AutoTypeTable path="./types/docs/qr-code.ts" name="QRCodeCanvasProps" />

### Svg

Renders the QR code as an SVG element.

<AutoTypeTable path="./types/docs/qr-code.ts" name="QRCodeSvgProps" />

### Overlay

Overlays content (like logos or icons) in the center of the QR code.

<AutoTypeTable path="./types/docs/qr-code.ts" name="QRCodeOverlayProps" />

### Skeleton

Displays a loading placeholder while the QR code is being generated. Automatically hides once the QR code is ready.

<AutoTypeTable path="./types/docs/qr-code.ts" name="QRCodeSkeletonProps" />

### Download

A button component for downloading the QR code.

<AutoTypeTable path="./types/docs/qr-code.ts" name="QRCodeDownloadProps" />
