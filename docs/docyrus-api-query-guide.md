...
- **Formulas** — computed virtual columns (simple and block/AST-based)
...
There are three formula formats:

### 1. Simple Formula

Single-depth function call with positional arguments. Column references use `{column_name}` syntax.

```typescript
interface IQuerySimpleFormula {
  func: string // function name (e.g. "to_char")
  args: Array<string | number> // arguments, column refs use {col}
}
```
...
```json
{
  "columns": "id, name, formatted_date",
  "formulas": {
    "formatted_date": {
      "func": "to_char",
      "args": ["{created_on}", "DD/MM/YYYY"]
    }
  }
}
```

> SQL: `to_char("t0"."created_on", $1::text) as "formatted_date"`

**Example: Uppercase a Name**
...
| Category      | Functions                                                                                                                                                                                                             |
| ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **String**    | `length`, `lower`, `upper`, `substr`, `substring`, `replace`, `concat`, `trim`, `ltrim`, `rtrim`, `left`, `right`, `reverse`, `locate`, `lpad`, `rpad`                                                                |
| **Number**    | `abs`, `ceil`, `ceiling`, `floor`, `round`, `sqrt`, `power`, `pow`, `mod`, `exp`, `ln`, `log`, `log10`, `sign`, `truncate`, `greatest`, `least`                                                                       |
| **Date/Time** | `now`, `curdate`, `curtime`, `current_date`, `current_time`, `current_timestamp`, `date`, `time`, `year`, `month`, `day`, `hour`, `minute`, `second`, `date_format`, `str_to_date`, `unix_timestamp`, `from_unixtime` |
| **Utility**   | `coalesce`, `ifnull`, `format`                                                                                                                                                                                        |
| **JSON**      | `json_value`, `json_extract`                                                                                                                                                                                          |

### ClickHouse Functions

| Category      | Functions                                                                                                                                      |
| ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| **String**    | `length`, `lower`, `upper`, `substr`, `substring`, `replace`, `concat`, `trim`, `ltrim`, `rtrim`, `reverse`, `position`, `leftPad`, `rightPad` |
| **Number**    | `abs`, `ceil`, `floor`, `round`, `sqrt`, `pow`, `mod`, `exp`, `ln`, `log`, `log10`, `sign`, `trunc`, `greatest`, `least`                       |
| **Date/Time** | `now`, `today`, `yesterday`, `toYear`, `toMonth`, `toDayOfMonth`, `toHour`, `toMinute`, `toSecond`, `formatDateTime`, `parseDateTime`          |
| **Utility**   | `coalesce`, `ifnull`, `multiif`                                                                                                                |
...
These aggregate functions work across all dialects:
...
### Example 9: Date Formatting with Simple Formula
...
```json
{
  ...
  "formulas": {
    "formatted_date": {
      "func": "to_char",
      "args": ["{created_on}", "DD Mon YYYY"]
    },
    "formatted_time": {
      "func": "to_char",
      "args": ["{created_on}", "HH24:MI"]
    }
  },
  "orderBy": "created_on DESC",
  "limit": 50
