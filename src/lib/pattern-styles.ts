...
export const patternStyles: Record<PatternStyle, string> = {
  ...
  dots: 'radial-gradient(circle, var(--stripe-color, rgba(0,0,0,0.04)) 1px, transparent 1px)',
  grid: 'linear-gradient(var(--stripe-color, rgba(0,0,0,0.03)) 1px, transparent 1px), linear-gradient(90deg, var(--stripe-color, rgba(0,0,0,0.03)) 1px, transparent 1px)',
  crosshatch:
