...
function ImageEditor({
  ...
  const stencilProps = {
    ...
    ...(stencilShape === 'circle' && aspectRatio === undefined && { aspectRatio: 1 })
  };
  ...
  return (
    <div
      ...
      {...props}>
      <div
        data-slot="image-editor-cropper"
        ...
        {mode !== 'crop' && (
          <div className="pointer-events-auto absolute bottom-5 left-1/2 w-full max-w-95 -translate-x-1/2 px-6">
