            ...
            <TooltipProvider>
              <div className="flex items-center gap-0.5 px-2 py-1">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>{tUi(locale, 'ecStrikethrough')}</TooltipContent>
                </Tooltip>
                ...
                <Tooltip>
                  ...
                  <TooltipContent>{tUi(locale, 'ecBulletedList')}</TooltipContent>
                </Tooltip>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Toggle
                  ...
                  <TooltipContent>{tUi(locale, 'ecOrderedList')}</TooltipContent>
                </Tooltip>
