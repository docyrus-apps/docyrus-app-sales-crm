...
export type SharingPermissionValue =
...
export type SharingPermissionPresetValue =
  (typeof SharingPermissionPreset)[keyof typeof SharingPermissionPreset]
...
export interface RecordSharingPanelProps {
  ...
  onSearch: (
    query: string,
  ) => Promise<SharingSearchResult[]> | SharingSearchResult[]
  onAdd: (
    entities: Array<{
      id: string
      type: SharingResourceType
