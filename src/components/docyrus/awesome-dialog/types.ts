...
export interface GlobalDialogContextValue {
  ...
  minimizedDialogs: Array<DialogState>
}
...
> = {
  sm: { horizontal: '320px', vertical: '30vh' },
  default: { horizontal: '420px', vertical: '40vh' },
  lg: { horizontal: '560px', vertical: '55vh' },
  xl: { horizontal: '720px', vertical: '70vh' },
  full: { horizontal: '100%', vertical: '100%' },
}
