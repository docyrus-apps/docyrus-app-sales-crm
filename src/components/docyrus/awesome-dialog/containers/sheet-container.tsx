...
const sideClasses: Record<DialogSide, string> = {
  right:
    'inset-y-0 right-0 h-full border-l data-[state=closed]:slide-out-to-right-10 data-[state=open]:slide-in-from-right-10',
  ...
  bottom:
    'inset-x-0 bottom-0 w-full sm:w-auto border-t data-[state=closed]:slide-out-to-bottom-10 data-[state=open]:slide-in-from-bottom-10 sm:left-1/2 sm:-translate-x-1/2 sm:rounded-t-xl',
}
