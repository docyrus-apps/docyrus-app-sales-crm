...
const sideClasses: Record<DialogSide, string> = {
  ...
  bottom: 'inset-x-0 bottom-0 w-full sm:w-auto border-t data-closed:slide-out-to-bottom-10 data-open:slide-in-from-bottom-10 sm:left-1/2 sm:-translate-x-1/2 sm:rounded-t-xl'
};
