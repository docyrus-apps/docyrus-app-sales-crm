...
const ContactActivityContext =
  createContext<ContactActivityContextValue | null>(null)
...
export function useContactActivityContext(): ContactActivityContextValue {
  ...
  if (!ctx) {
    throw new Error(
      'useContactActivityContext must be used within a ContactActivityProvider',
    )
  }
