...
import {
  ChevronDownIcon, Loader2Icon, ReplyIcon
} from 'lucide-react';
...
import { getActivityTypeConfig, isCompactActivity } from './activity-type-config';
...
export function ActivityThread({
  ...
  const handleSubmitReply = useCallback(
    async (content: Value, _parentId?: string, files?: Array<File>, entities?: Array<LinkedEntity>) => {
              ...
              <Button
                ...
                {isLoadingReplies ? (
                  ...
                  <>
                    ...
                    <span>View {activity.reply_count} {activity.reply_count === 1 ? 'reply' : 'replies'}</span>
                  </>
                )}
              </Button>
            </div>
