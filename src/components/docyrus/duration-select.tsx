    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-auto p-0" align="start">
        <div
          ...
          role="grid"
          aria-label={t('ui.common.durationPicker', 'Duration picker')}
        >
          {/* Corner cell */}
          <div className="h-7" />
                ...
                {minuteCols.map((m, colIdx) => {
                  ...
                  return (
                    <button
                      ...
                      aria-label={`${h} ${t('ui.common.hours', 'hours')} ${m} minutes`}
                      className={cn(
