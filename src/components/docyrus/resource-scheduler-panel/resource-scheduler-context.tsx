...
const ResourceSchedulerContext = createContext<ResourceSchedulerContextValue | null>(null);
...
export function useResourceSchedulerContext(): ResourceSchedulerContextValue {
  ...
  if (!ctx) {
    throw new Error('useResourceSchedulerContext must be used within a ResourceSchedulerProvider');
  }
