...
export type SlotStatus = 'available' | 'partial' | 'full' | 'unavailable' | 'past' | 'disabled';

export type DisabledReason = 'past' | 'full' | 'unavailable' | 'before-min-date' | 'after-max-date';
