...
const TimeSlotSchedulerContext =
  createContext<TimeSlotSchedulerContextValue | null>(null)
...
export function useTimeSlotSchedulerContext(): TimeSlotSchedulerContextValue {
  ...
  if (!ctx) {
    throw new Error(
      'useTimeSlotSchedulerContext must be used within a TimeSlotSchedulerProvider',
    )
  }
