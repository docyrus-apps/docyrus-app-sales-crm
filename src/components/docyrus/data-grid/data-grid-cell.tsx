...
import {
  memo, useCallback, useMemo, type ComponentType, type MouseEvent
} from 'react';
...
import { type GroupableCellVariant } from './lib/data-grid-grouping';
...
function GroupedHeaderCell<TData>({
  ...
  const presentation = variant ? resolveGroupHeaderPresentation({
    variant,
    ...
    label:
          typeof groupedRow.groupingValue === 'string' ? groupedRow.groupingValue : String(groupedRow.groupingValue ?? '')
  };
