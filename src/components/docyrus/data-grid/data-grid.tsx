                ...
                {headerGroup.headers.map((header, colIndex) => {
                  ...
                  return (
                    <div
                      ...
                      aria-sort={currentSort?.desc === false ? 'ascending' : currentSort?.desc === true ? 'descending' : isSortable ? 'none' : undefined}
                      ...
                      style={{
                        ...getColumnPinningStyle({ column: header.column, dir, background: 'var(--muted)' }),
