...
import { MentionUsersContext, type MentionUser } from '@/lib/editor-mention';
...
export function CommentsPanel({
  ...
  const resolvedHeight = maxHeight ? (typeof maxHeight === 'number' ? `${maxHeight}px` : maxHeight) : '24rem';
