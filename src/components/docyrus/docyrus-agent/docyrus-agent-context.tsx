...
export const DocyrusAgentProvider = ({
  ...
  const [actionPanelView, setActionPanelView] =
    useState<ActionPanelView>('action-list')

  const [internalFeatureFlags, setInternalFeatureFlags] =
    useState<AgentFeatureFlags>(() => ({
