...
export interface DocyrusAgentProjectsViewProps {
  ...
  renderCard?: (
    project: DocyrusAgentProject,
    props: DocyrusAgentProjectsViewRenderCardProps,
  ) => ReactNode
...
export const DocyrusAgentProjectsView = ({
  ...
  const [renameTarget, setRenameTarget] = useState<DocyrusAgentProject | null>(
    null,
  )
  const [deleteTarget, setDeleteTarget] = useState<DocyrusAgentProject | null>(
    null,
  )
          ...
          >
            {filtered.map((project) => {
              const cardProps = {
                ...
                onEdit:
                  (onEditClick ?? onRenameProject) ? handleEdit : undefined,
                onDelete:
                  (onDeleteClick ?? onDeleteProject) ? handleDelete : undefined,
              }
