      ...
      <DialogContent className={className}>
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {title?.(editing) ?? t(editing ? 'ui.agent.memories.edit' : 'ui.agent.memories.new', editing ? 'Edit memory' : 'New memory')}
          </DialogTitle>
        </DialogHeader>
        ...
        <DialogFooter>
          {footer?.({
            canSubmit, cancel, form, saving, submit
          }) ?? (
            <>
              ...
              <Button disabled={!canSubmit || saving} onClick={submit}>
                {saving ? t('ui.agent.memories.saving', 'Saving…') : t('ui.agent.memories.save', 'Save')}
              </Button>
            </>
          )}
        </DialogFooter>
