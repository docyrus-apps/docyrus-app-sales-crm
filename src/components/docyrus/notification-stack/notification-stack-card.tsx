...
import {
  motion, useMotionValue, useTransform, type PanInfo
} from 'motion/react';
...
const notificationStackCardVariants = cva(
  'relative w-full rounded-lg border border-border bg-card shadow-sm select-none touch-pan-y',
  {
    variants: {
      variant: {
        default: '',
...
interface NotificationStackCardProps
  extends VariantProps<typeof notificationStackCardVariants> {
...
const NotificationStackCard = forwardRef<HTMLDivElement, NotificationStackCardProps>(
  (
    {
      className,
      size,
        ...
        <div
          ...
          <div className="flex-1 min-w-0 pr-4">
            ...
            {notification.subtitle && (
              <div className="mt-1 text-muted-foreground">{notification.subtitle}</div>
            )}

            {notification.content && (
              <div className="mt-1 text-muted-foreground">{notification.content}</div>
            )}
