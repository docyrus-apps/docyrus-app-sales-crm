    ...
    >
      ...
      <div className="flex min-w-0 flex-1 flex-wrap items-center gap-1">
        {recipients.map((recipient, index) => (
          ...
          >
            <span className="max-w-[160px] truncate">{recipient}</span>
            {!disabled && (
              <button
                type="button"
        ...
        <input
          ...
          disabled={disabled}
          className="min-w-[100px] flex-1 bg-transparent py-0.5 text-sm outline-none placeholder:text-muted-foreground disabled:cursor-not-allowed"
        />
      </div>
      {suffix}
    </div>
