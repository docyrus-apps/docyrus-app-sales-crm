...
export function AvatarField({
  ...
  const snapshotRef = useRef<{ icon: unknown; color: unknown; image: unknown } | null>(null);
          ...
          children={(colorField: any) => (
            <form.Field
              ...
              children={(imageField: any) => {
                ...
                const mergedErrors = [...iconField.state.meta.errors, ...colorField.state.meta.errors, ...imageField.state.meta.errors].filter(Boolean);
                const isTouched
