...
export interface CodyAgentToggleProps extends Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'children'> {
...
export function CodyAgentToggle({
  active, label = 'Cody', iconOnly = false, className, ref, ...props
