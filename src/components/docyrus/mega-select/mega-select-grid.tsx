...
export interface MegaSelectGridProps
  extends
    Omit<HTMLAttributes<HTMLDivElement>, 'columns'>,
...
const MegaSelectGrid = forwardRef<HTMLDivElement, MegaSelectGridProps>(
  ({ className, columns, height = '100%', ...props }, ref) => {
    const { filteredItems, loading, items, locale } = useMegaSelect()
