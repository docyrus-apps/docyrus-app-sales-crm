...
const SUPPORTED_GROUP_FIELD_TYPES = new Set<string>([
  'field-select',
  'field-radioGroup',
  'field-status',
  'field-userSelect',
        ...
        {finalColumns.length > 0 && (
          <KanbanFinalZone className="shrink-0 px-3 pb-3">
            {finalColumns.map((col) => {
              const badge = getEnumBadgeColors(col.color ?? undefined)
...
export { SUPPORTED_GROUP_FIELD_TYPES as DOCYRUS_KANBAN_SUPPORTED_FIELD_TYPES }
