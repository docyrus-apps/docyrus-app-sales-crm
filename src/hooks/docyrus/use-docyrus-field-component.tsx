...
import { AdaptiveCardFormField } from '@/components/docyrus/form-fields/adaptive-card-form-field'
...
import { JsonSchemaFormField } from '@/components/docyrus/form-fields/json-schema-form-field'
import { JsonataFormField } from '@/components/docyrus/form-fields/jsonata-form-field'
import { HandlebarsFormField } from '@/components/docyrus/form-fields/handlebars-form-field'
import { LocationSelectFormField } from '@/components/docyrus/form-fields/location-select-form-field'
import { MarkdownEditorFormField } from '@/components/docyrus/form-fields/markdown-editor-form-field'
...
import { PasswordFormField } from '@/components/docyrus/form-fields/password-form-field'
...
import { AdaptiveCardValue } from '@/components/docyrus/value-renderers/adaptive-card-value'
...
import { MarkdownValue } from '@/components/docyrus/value-renderers/markdown-value'
...
import { PasswordValue } from '@/components/docyrus/value-renderers/password-value'
...
> = {
  ...
  'field-password': PasswordFormField,
  ...
  'field-markdown': MarkdownEditorFormField,
  'field-emailEditor': EmailEditorFormField,
  'field-codeEditor': CodeEditorFormField,
  'field-json': (props: DocyrusFormFieldProps) => (
    <CodeEditorFormField {...props} language="json" />
  ),
  'field-jsonSchema': JsonSchemaFormField,
  'field-jsonata': JsonataFormField,
  'field-handlebars': HandlebarsFormField,
  'field-adaptiveCard': AdaptiveCardFormField,
...
> = {
  ...
  'field-markdown': MarkdownValue,
  'field-emailEditor': RichTextValue,
  'field-codeEditor': CodeValue,
  'field-docEditor': DocEditorValue,
  'field-json': JsonValue,
  'field-jsonSchema': JsonValue,
  'field-jsonata': CodeValue,
  'field-handlebars': CodeValue,
  'field-adaptiveCard': AdaptiveCardValue,
  'field-queryBuilder': JsonValue,
  'field-schemaRepeater': InlineDataValue,
  'field-inlineForm': JsonValue,
  ...
  'field-systemBuffer': InlineDataValue,
  'field-systemVector': InlineDataValue,
  'field-systemTextArray': InlineDataValue,
  'field-systemUuidArray': InlineDataValue,
}
...
export const CELL_COMPONENT_MAP: Partial<Record<IFieldType, CellComponent>> = {
  ...
  'field-markdown': LongTextCell as CellComponent,
...
export function getCellOpts(
  ...
  switch (field.type) {
    ...
    case 'field-autonumber':
      return { variant: 'number', decimalPrecision: 0, thousandSeparator: '' }
...
export function buildTanstackColumnDef<TData = unknown>(
  ...
  const ValueRenderer = VALUE_RENDERER_MAP[fieldType] ?? TextValue
