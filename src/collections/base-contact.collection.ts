...
export const baseContactCollection = {
  ...
  list: (params?: ICollectionListParams): Promise<Array<BaseContactEntity>> =>
    apiClient.get('/v1/apps/base/data-sources/contact/items', params as Record<string, QueryParamValue> | undefined),

  /** Get record */
  get: (recordId: string, params?: { columns?: Array<string> }): Promise<BaseContactEntity> => 
