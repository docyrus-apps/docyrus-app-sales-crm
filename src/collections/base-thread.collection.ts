...
export const baseThreadCollection = {
  ...
  list: (params?: ICollectionListParams): Promise<Array<BaseThreadEntity>> =>
    apiClient.get('/v1/apps/base/data-sources/thread/items', params as Record<string, QueryParamValue> | undefined),

  /** Get record */
  get: (recordId: string, params?: { columns?: Array<string> }): Promise<BaseThreadEntity> => 
