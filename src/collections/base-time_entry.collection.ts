...
export const baseTimeEntryCollection = {
  ...
  list: (params?: ICollectionListParams): Promise<Array<BaseTimeEntryEntity>> =>
    apiClient.get('/v1/apps/base/data-sources/time_entry/items', params as Record<string, QueryParamValue> | undefined),

  /** Get record */
  get: (recordId: string, params?: { columns?: Array<string> }): Promise<BaseTimeEntryEntity> => 
  ...
  /** Update record */
  update: (recordId: string, data: { data: any }): Promise<BaseTimeEntryEntity> => 
