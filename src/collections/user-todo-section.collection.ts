...
export const userTodoSectionCollection = {
  ...
  list: (params?: ICollectionListParams): Promise<Array<UserTodoSectionEntity>> =>
    apiClient.get('/v1/apps/user/data-sources/todo-section/items', params as Record<string, QueryParamValue> | undefined),
