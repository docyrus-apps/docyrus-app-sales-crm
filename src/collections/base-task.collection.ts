...
export const baseTaskCollection = {
  ...
  list: (params?: ICollectionListParams): Promise<Array<BaseTaskEntity>> =>
    apiClient.get('/v1/apps/base/data-sources/task/items', params as Record<string, QueryParamValue> | undefined),

  /** Get record */
  get: (recordId: string, params?: { columns?: Array<string> }): Promise<BaseTaskEntity> => 
