...
export const baseMessageCollection = {
  ...
  list: (params?: ICollectionListParams): Promise<Array<BaseMessageEntity>> =>
    apiClient.get('/v1/apps/base/data-sources/message/items', params as Record<string, QueryParamValue> | undefined),

  /** Get record */
  get: (recordId: string, params?: { columns?: Array<string> }): Promise<BaseMessageEntity> => 
